...
export const Categories = ({ hasPurchased }: CategoriesProps) => {
  ...
  const testServer = process.env.NEXT_PUBLIC_TEST_SERVER;
  ...
  return (
    <div className="flex flex-col gap-1 p-2 thin-scrollbar mt-4  overflow-y-auto">
      {loading && <p>Loading...</p>}
      <button
        style={{
          backgroundColor: "",
