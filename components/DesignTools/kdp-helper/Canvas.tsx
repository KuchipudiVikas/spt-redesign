...
import { GetMargin } from "../kdp-helper";
import { TMarginIndex } from "@/data/kdp-helper/kdp-helper";
import { Ecover } from "../kdp-helper";
...
CanvasProps) => {
  ...
  return (
    <div className="flex flex-col min-w-full md:min-w-[600px]  items-center">
      <h3 className="mb-4  font-sans text-gray-700 m ">Template</h3>
