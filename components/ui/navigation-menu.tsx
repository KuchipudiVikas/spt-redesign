...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn(
      "group flex flex-1 list-none w-full items-center justify-center space-x-1",
      className
    )}
    {...props}
  />
...
>(({ className, rightAligned, ...props }, ref) => (
  <div
    className={cn(
      "absolute top-full flex",
      rightAligned ? "justify-end right-0" : "justify-center left-0"
    )}
  >
