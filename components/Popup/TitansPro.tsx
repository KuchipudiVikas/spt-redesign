      ...
      <div>
        ...
        >
          ...
          <div className="pb-8 mainHeader">
            ...
            <h5 className="text-center font-semibold text-white  mt-2">
              33% discount launch special
            </h5>
          </div>
        </div>
            ...
            <div>
              <div className="grid grid-cols-1 md:grid-cols-2">
                {overviewTexts.map((text, index) => (
                  <div
                    className="flex items-center smMargin mt-2 w-fit my-2 contentList"
                    key={index}
                  >
                    ...
                    <h4 className={` listItem  mx-2`}>{text}</h4>
                  </div>
                ))}
              </div>

              <div className="flex justify-center w-full mt-7 contentList">
                <Button
                  className={`custombutton2 themeGradient mt-5 twButton  p-3 text-[22px] w-fit px-10 text-center    winterThemebt1`}
                  onClick={() => {
                    router.replace("/titans-pro");
                  }}
                >
                  Get It Now
                </Button>
