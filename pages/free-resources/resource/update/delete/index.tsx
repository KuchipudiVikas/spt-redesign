...
const Update: React.FC = () => {
  ...
  //   router.push(`/free-resources/resource/update/${id}`);
  // };
  ...
  const columns: GridColDef[] = [
    { field: "id", headerName: "ID", width: 70 },
    {
      ...
      width: 300,
      renderCell: (params) => (
        <Linkn href={`/free-resources/resource/single/${params.row.id}`}>
    ...
    { field: "updatedAt", headerName: "Updated At", width: 180 },
    {
      ...
      renderCell: (params) => (
        <>
          <Linkn href={`/free-resources/resource/update/${params.row.id}`}>
            <IconButton
              color="secondary"
