...
const handler = async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  try {
    ...
    let query =
      "SELECT * FROM imageindex WHERE is_private = false and type = $1 AND  category = $2 LIMIT $3 OFFSET $4";
    ...
    const hasMoreQuery =
      "SELECT COUNT(*) FROM imageindex WHERE is_private = false and type = $1 AND category = $2";
